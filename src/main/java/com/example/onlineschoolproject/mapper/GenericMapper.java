...
public abstract class GenericMapper<E extends GenericModel, D extends GenericDTO> implements Mapper<E, D>{
    ...
    protected abstract <T extends GenericModel> List<Long> getIds(E entity, Class<T> clazz);
    protected abstract <T extends GenericModel> Long getId(E entity, Class<T> clazz);
}
